...
import { ISaleProductTransfer, InfoQnt } from "./sale_product/sale_product.transfer.interface";
import { IOrderProductDelete } from "./order_product/orderProduct.delete.interface";
export { IUserCreate, IProductCategory, IProductCreate, IReturnedProduct, IProductUpdate, IOrderProductCreate, IStockProduct, IUpdateStockProduct, ISaleProductTransfer, InfoQnt, IOrderProductDelete, };
