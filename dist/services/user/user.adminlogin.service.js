...
exports.userAdminLoginService = void 0;
...
const userAdminLoginService = (body) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!user.isAdm) {
        throw new appError_1.default("Unauthorized, please login with an Administrator account.", 401);
    }
...
exports.userAdminLoginService = userAdminLoginService;
